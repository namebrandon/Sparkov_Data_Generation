...
class TestCustomer(unittest.TestCase):
    ...
    def test_generate_age_gender(self, fake, random_mock, np_random_mock):
        ...
        results = [
            (0.01, ('M', date(2003, 1, 4))),
            (0.02, ('F', date(2003, 1, 4))),
            (0.03, ('F', date(2002, 1, 4))),
            (0.04, ('M', date(2001, 1, 4))),
            (0.05, ('M', date(2000, 1, 4))),
            (0.06, ('F', date(2000, 1, 4))),
            (0.07, ('F', date(1999, 1, 4))),
            (0.08, ('M', date(1998, 1, 4))),
            (0.09, ('F', date(1998, 1, 4))),
            (0.1, ('F', date(1997, 1, 4))),
            (0.11, ('M', date(1996, 1, 4))),
            (0.12, ('F', date(1996, 1, 4))),
            (0.13, ('M', date(1995, 1, 4))),
            (0.14, ('M', date(1994, 1, 4))),
            (0.15, ('F', date(1994, 1, 4))),
            (0.16, ('M', date(1993, 1, 4))),
            (0.17, ('F', date(1993, 1, 4))),
            (0.18, ('M', date(1992, 1, 4))),
            (0.19, ('M', date(1991, 1, 4))),
            (0.2, ('F', date(1991, 1, 4))),
            (0.21, ('M', date(1990, 1, 4))),
            (0.22, ('F', date(1990, 1, 4))),
            (0.23, ('M', date(1989, 1, 4))),
            (0.24, ('M', date(1988, 1, 4))),
            (0.25, ('F', date(1988, 1, 4))),
            (0.26, ('M', date(1987, 1, 4))),
            (0.27, ('F', date(1987, 1, 4))),
            (0.28, ('F', date(1986, 1, 4))),
            (0.29, ('M', date(1985, 1, 4))),
            (0.3, ('F', date(1985, 1, 4))),
            (0.31, ('F', date(1984, 1, 4))),
            (0.32, ('M', date(1983, 1, 4))),
            (0.33, ('F', date(1983, 1, 4))),
            (0.34, ('M', date(1982, 1, 4))),
            (0.35, ('M', date(1981, 1, 4))),
            (0.36, ('F', date(1981, 1, 4))),
            (0.37, ('M', date(1980, 1, 4))),
            (0.38, ('F', date(1980, 1, 4))),
            (0.39, ('M', date(1979, 1, 4))),
            (0.4, ('M', date(1978, 1, 4))),
            (0.41, ('F', date(1978, 1, 4))),
            (0.42, ('M', date(1977, 1, 4))),
            (0.43, ('F', date(1977, 1, 4))),
            (0.44, ('M', date(1976, 1, 4))),
            (0.45, ('F', date(1976, 1, 4))),
            (0.46, ('M', date(1975, 1, 4))),
            (0.47, ('M', date(1974, 1, 4))),
            (0.48, ('F', date(1974, 1, 4))),
            (0.49, ('M', date(1973, 1, 4))),
            (0.5, ('F', date(1973, 1, 4))),
            (0.51, ('M', date(1972, 1, 4))),
            (0.52, ('F', date(1972, 1, 4))),
            (0.53, ('M', date(1971, 1, 4))),
            (0.54, ('F', date(1971, 1, 4))),
            (0.55, ('M', date(1970, 1, 4))),
            (0.56, ('F', date(1970, 1, 4))),
            (0.57, ('M', date(1969, 1, 4))),
            (0.58, ('F', date(1969, 1, 4))),
            (0.59, ('M', date(1968, 1, 4))),
            (0.6, ('M', date(1967, 1, 4))),
            (0.61, ('F', date(1967, 1, 4))),
            (0.62, ('M', date(1966, 1, 4))),
            (0.63, ('F', date(1966, 1, 4))),
            (0.64, ('M', date(1965, 1, 4))),
            (0.65, ('F', date(1965, 1, 4))),
            (0.66, ('M', date(1964, 1, 4))),
            (0.67, ('F', date(1964, 1, 4))),
            (0.68, ('M', date(1963, 1, 4))),
            (0.69, ('F', date(1963, 1, 4))),
            (0.7, ('M', date(1962, 1, 4))),
            (0.71, ('F', date(1962, 1, 4))),
            (0.72, ('F', date(1961, 1, 4))),
            (0.73, ('M', date(1960, 1, 4))),
            (0.74, ('F', date(1960, 1, 4))),
            (0.75, ('M', date(1959, 1, 4))),
            (0.76, ('M', date(1958, 1, 4))),
            (0.77, ('F', date(1958, 1, 4))),
            (0.78, ('M', date(1957, 1, 4))),
            (0.79, ('M', date(1956, 1, 4))),
            (0.8, ('F', date(1956, 1, 4))),
            (0.81, ('F', date(1955, 1, 4))),
            (0.82, ('M', date(1954, 1, 4))),
            (0.83, ('M', date(1953, 1, 4))),
            (0.84, ('F', date(1953, 1, 4))),
            (0.85, ('M', date(1951, 1, 4))),
            (0.86, ('M', date(1950, 1, 4))),
            (0.87, ('M', date(1949, 1, 4))),
            (0.88, ('M', date(1948, 1, 4))),
            (0.89, ('F', date(1947, 1, 4))),
            (0.9, ('F', date(1946, 1, 4))),
            (0.91, ('M', date(1944, 1, 4))),
            (0.92, ('F', date(1943, 1, 4))),
            (0.93, ('F', date(1941, 1, 4))),
            (0.94, ('F', date(1939, 1, 4))),
            (0.95, ('M', date(1937, 1, 4))),
            (0.96, ('F', date(1935, 1, 4))),
            (0.97, ('F', date(1933, 1, 4))),
            (0.98, ('F', date(1931, 1, 4))),
            (0.99, ('F', date(1929, 1, 4)))
        ]
    ...
    def test_find_profile(self, fake, random_mock, np_random_mock):
        ...
        results = [
            ...
            (0.51, 'adults_2550_male_urban.json') ,
            (0.52, 'adults_2550_female_urban.json') ,
